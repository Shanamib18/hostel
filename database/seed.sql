...
(1, 'Caretaker 1', 'caretaker1@lbscek.ac.in',
 '$2a$10$ebEm8uRxx7MywVeXWCd3quIFpwZyLygkxKz4Kk68xyVPZ8GrB1UvS', 'caretaker', '9999990003'),

(1, 'Caretaker 2', 'caretaker2@lbscek.ac.in',
 '$2a$10$ebEm8uRxx7MywVeXWCd3quIFpwZyLygkxKz4Kk68xyVPZ8GrB1UvS', 'caretaker', '9999990004'),

(1, 'Mess Manager', 'mess@lbscek.ac.in',
 '$2a$10$ebEm8uRxx7MywVeXWCd3quIFpwZyLygkxKz4Kk68xyVPZ8GrB1UvS', 'mess_manager', '9999990005'),

(1, 'Security 1', 'security1@lbscek.ac.in',
 '$2a$10$ebEm8uRxx7MywVeXWCd3quIFpwZyLygkxKz4Kk68xyVPZ8GrB1UvS', 'security', '9999990006'),

(1, 'Security 2', 'security2@lbscek.ac.in',
 '$2a$10$ebEm8uRxx7MywVeXWCd3quIFpwZyLygkxKz4Kk68xyVPZ8GrB1UvS', 'security', '9999990007'),

(1, 'Security 3', 'security3@lbscek.ac.in',
 '$2a$10$ebEm8uRxx7MywVeXWCd3quIFpwZyLygkxKz4Kk68xyVPZ8GrB1UvS', 'security', '9999990008');

-- --------------------------------------------------
-- 4. STUDENTS (278 students)
-- --------------------------------------------------
...
-- Using INSERT IGNORE to skip duplicates based on unique constraints (student_id, email)
...
(1, '2025B571', 'Nafia P', 'Nafiap683@gmail.com', '09895108189', 'Noushad kp', '7358926733', 'CSE', 1, (SELECT id FROM rooms WHERE room_number = 'F09'), @pwd_hash, TRUE),
...
(1, '2024B520', 'Fathimath Thanveera', 'thansh380@gmail.com', '08129840656', 'Thahira', '9567351806', 'Civil Engineering', 2, (SELECT id FROM rooms WHERE room_number = 'G29'), @pwd_hash, TRUE),
...
(1, '2025B578', 'Gouri Parvathi T.M', 'gouri.madhav07@gmail.com', '919744556577', 'Suresh T.M', '7994224455', 'CSE', 1, (SELECT id FROM rooms WHERE room_number = 'F11'), @pwd_hash, TRUE),
...
-- --------------------------------------------------
-- 7. SAMPLE FACE ENCODINGS
-- --------------------------------------------------

DELETE FROM face_encodings;

INSERT INTO face_encodings
(id, user_type, user_id, encoding_data, image_path)
SELECT
    CONCAT('face_student_', id),
    'student',
    id,
    'sample-encoded-vector-data',
    NULL
FROM students
LIMIT 20;
...
VALUES (
    'Mess Secretary', 
    'mess@lbscek.ac.in', 
    '$2a$10$ebEm8uRxx7MywVeXWCd3quIFpwZyLygkxKz4Kk68xyVPZ8GrB1UvS'
);
